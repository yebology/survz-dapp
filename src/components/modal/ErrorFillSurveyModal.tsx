...
export const ErrorFillSurveyModal = () => {
  const [modalScale] = useGlobalState("errorFillSurveyModalScale");

  const onClose = () => {
    setGlobalState("errorFillSurveyModalScale", "scale-0");
  };
