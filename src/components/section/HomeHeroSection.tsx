...
export const HomeHeroSection = () => {
  return (
    <div className="mt-24 pt-32 md:py-12 xl:container m-auto px-6 md:px-12">
      <div
        className="absolute inset-0 my-auto w-96 h-44 bg-gradient-to-r from-[#6a0572] via-[#8e44ad] to-[#a29bfe] blur-3xl opacity-40 dark:opacity-20"
      ></div>
      <div className="relative lg:flex lg:items-center lg:gap-36">
        <div className="text-center lg:text-left md:mt-12 lg:mt-0 sm:w-10/12 md:w-2/3 sm:mx-auto lg:mr-auto lg:w-6/12">
          ...
          <p className="mt-8 text-n-2 dark:text-gray-300 text-md">
            With Survz, complete 5 questions and earn SOL rewards. Share your
